...
os.path é um módulo que fornece funções para trabalhar com caminhos
de arquivos em Windows, Mac ou Linux sem precisar se preocupar
com as diferenças entre esses sistemas.
...
os.path.exists: verificar se um caminho especificado existe.
...
print(nomeArquivo, extensaoArquivo)

print(os.path.exists(caminho))
print(os.path.exists('/home/pedro-souza/Documentos/CursoLuizOtavioMiranda-Python'))
